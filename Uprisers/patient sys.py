...
root = Tk()
root.title("Doctor-X~ Appointment System ***UPRISERS CREATION***")
root.configure(width=1500,height=600,bg='BLACK')
var=-1
"""HMRITM Uprisers CSE-2C
    ABHINAV GUPTA
    ABHISHEK SAINI
    AMAN SRIVASTAVA
    MUSKAN MALHOTRA"""
...
def clearitem():
    ...
    entry5.delete(0, END)
#fn1353
label0= Label(root,text="Doctor-X~ Appointment System ***UPRISERS CREATION*** ",bg="black",fg="white",font=("Times", 30))
label1=Label(root,text="ENTER PATIENT NAME",bg="blue",relief="ridge",fg="white",font=("Times", 12),width=25)
entry1=Entry(root , font=("Times", 12))
label2=Label(root, text="ENTER PATIENT AGE",bd="2",relief="ridge",height="1",bg="blue",fg="white", font=("Times", 12),width=25)
entry2= Entry(root, font=("Times", 12))
label3=Label(root, text="ENTER PATIENT GENDER",bd="2",relief="ridge",bg="blue",fg="white", font=("Times", 12),width=25)
entry3= Entry(root, font=("Times", 12))
label4=Label(root, text="ENTER PATIENT'S PROBLEMS",bd="2",relief="ridge",bg="blue",fg="white", font=("Times", 12),width=25)
entry4= Entry(root, font=("Times", 12))
label5=Label(root, text="ENTER MOBILE NUMBER",bg="blue",relief="ridge",fg="white", font=("Times", 12),width=25)
entry5= Entry(root, font=("Times", 12))
button1= Button(root, text="ADD PATIENT", bg="white", fg="black", width=20, font=("Times", 12),command=additem)
button2= Button(root, text="DELETE PATIENT", bg="white", fg="black", width =20, font=("Times", 12),command=deleteitem)
button3= Button(root, text="VIEW FIRST PATIENT" , bg="white", fg="black", width =20, font=("Times", 12),command=firstitem)
button4= Button(root, text="VIEW NEXT PATIENT" , bg="white", fg="black", width =20, font=("Times", 12), command=nextitem)
button5= Button(root, text="VIEW PREVIOUS PATIENT", bg="white", fg="black", width =20, font=("Times", 12),command=previousitem)
button6= Button(root, text="VIEW LAST PATIENT", bg="white", fg="black", width =20, font=("Times", 12),command=lastitem)
button7= Button(root, text="UPDATE PATIENT", bg="white", fg="black", width =20, font=("Times", 12),command=updateitem)
button8= Button(root, text="SEARCH PATIENT", bg="white", fg="black", width =20, font=("Times", 12),command=searchitem)
